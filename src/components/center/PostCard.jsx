		...
		<div>
			<div className={style.post_card}>
				<div className={`${style.post_card_top} d-flex align-items-center`}>
					...
					<div className={style.icon_ellipsis}>
						<i className="fas fa-ellipsis-h"></i>
					</div>
				</div>
				<div className="mx-2 my-3">
					<span className="text-start text-wrap text-break">{props.description}</span>
				</div>
				...
				<ul
					className={`${style.comments} d-flex align-item-center justify-content-evenly m-auto`}
				>
					<li>
						<button
							className={`${style.comment_btn} d-flex align-items-center`}
						>
							<svg
							...
							<span className={style.comment_text}>Like</span>
						</button>
					</li>
					<li>
						<button
						...
						>
							...
							<span className={style.comment_text}>Comments</span>
						</button>
					</li>
					<li>
						<button
						...
						>
							...
							<span className={style.comment_text}>Share</span>
						</button>
					</li>
					<li>
						<button
						...
						>
							...
							<span className={style.comment_text}>Send</span>
						</button>
					</li>
				</ul>
			</div>
